...
instance Pretty Exp where
        ...
        prettyPrec _ (Tuple b expList) = parenList . map pretty $ expList
        prettyPrec _ (TupleSection b mExpList) = parenList . map (maybePP pretty) $ mExpList
        -- weird stuff
...
instance Pretty Pat where
        ...
        prettyPrec _ (PTuple b ps) = parenList . map pretty $ ps
...
instance SrcInfo loc => Pretty (P.PExp loc) where
        ...
        pretty (P.TupleSection _ b mExpList) = parenList . map (maybePP pretty) $ mExpList
